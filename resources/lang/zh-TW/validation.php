...
return [
    ...
    */
    ...
    'required_if'          => ':attribute 是必須的當 :other 是 :value',
    'required_unless'      => ':attribute 是必須的除非 :other 在 :values 中',
    'required_with'        => ':attribute 是必須的當 :values 是存在的',
    'required_with_all'    => ':attribute 是必須的當 :values 是存在的',
    'required_without'     => ':attribute 是必須的當 :values 是不存在的',
    'required_without_all' => ':attribute 是必須的當 沒有一個 :values 是存在的',
